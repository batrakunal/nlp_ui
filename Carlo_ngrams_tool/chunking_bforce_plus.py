...
def ngramming_bforce2 (file, stopwords, word_len, ngram_range, bigram_base_frequency, trigram_base_frequency):
    """
    ...
    :param file: string with the name of a corpus file (.txt)
    :type file: string
    ...
    bigram_freq_calc = int(bigram_base_frequency*len(counts))
    trigram_freq_calc = int(trigram_base_frequency*len(counts))
...
ngram_min = 2
ngram_max = 3
bigram_base_frequency = 0.0003 #the higher the number, the less bigrams will be extracted
trigram_base_frequency = 0.0008 #the higher the number, the less trigrams will be extracted
